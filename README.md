...
- Install [Visual C++ Redistributable 2013 Package](https://www.microsoft.com/en-US/download/details.aspx?id=40784) (This is needed for QR Code app)
...
- After creating a bot, BotFather will give you a token. Copy & paste it next to `BOT_TOKEN` variable in `.env` file
